...
import mythos.energy.na1 as jd_energy
...
def get_setup_data(base_dir: str):
    ...
    default_rna2_params = jd_toml.parse_toml("mythos/input/rna2/default_energy.toml")
    default_dna2_params = jd_toml.parse_toml("mythos/input/dna2/default_energy.toml")
    default_na1_params = jd_toml.parse_toml("mythos/input/na1/default_energy.toml")
