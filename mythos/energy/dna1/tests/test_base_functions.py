"""tests for mythos.energy.dna1.base_functions"""

import numpy as np
import pytest

import mythos.energy.dna1.base_functions as bf
import mythos.energy.dna1.tests.symbolic_base_functions as sp
