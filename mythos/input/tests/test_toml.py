...
def test_parse_str(value: str, expected: str) -> None:
    """Tests the mythos.input.toml.parse_str function."""
...
def test_parse_value(value: str | float | list[str] | list[float], expected: str | float | np.ndarray) -> None:
    """Tests the mythos.input.toml.parse_value function."""
...
def test_parse_toml(
    ...
    """Tests the mythos.input.toml.parse_toml function."""
