...
class oxDNASimulator(jd_base.BaseSimulation):  # noqa: N801 oxDNA is a special word
    ...
    def build(self, *, new_params: list[dict]) -> None:
        ...
        std_out = self.build_dir / "mythos.cmake.std.log"
        std_err = self.build_dir / "mythos.cmake.err.log"
        ...
        # rebuild the binary
        std_out = self.build_dir / "mythos.make.std.log"
        std_err = self.build_dir / "mythos.make.err.log"
        logger.debug(
