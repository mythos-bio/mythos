"""Simulation actors for use in an mythos.optimization.ray_optimization.Optimization loop."""
...
class SimulatorActor(BaseSimulator):
    ...
    a mythos.optimization.ray_optimization.Optimization. Because a simulation
